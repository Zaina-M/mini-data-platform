...
def sample_raw_data_with_errors() -> pd.DataFrame:
    ...
    return pd.DataFrame({
        "order_id": ["ORD-001001", "ORD-001002", "ORD-001003", "ORD-001001", "ORD-001005"],  # Duplicate
        "product_name": ["Laptop Pro 15", "  Wireless Mouse  ", "", "Keyboard", "Monitor"],  # Whitespace, empty
        "quantity": ["2", "-5", "invalid", "1", "0"],  # Negative, invalid, zero
        "unit_price": ["999.99", "29.99", "49.99", "0", "349.99"],  # Zero price
        "order_date": ["2024-01-15", "invalid-date", "2024-01-17", "2024-01-18", "2030-01-19"],  # Invalid, future
        "customer_id": ["CUST-10001", "", "CUST-10003", "CUST-10004", "CUST-10005"],  # Empty
        "country": ["United States", "  Canada  ", "", "InvalidCountry", "France"],  # Whitespace, empty, invalid
    })
