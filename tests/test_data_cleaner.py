...
from transformers.data_cleaner import DataCleaner, CleaningResult
...
class TestDataCleaner:
    ...
    def test_clean_with_data_quality_issues(self, sample_raw_data_with_errors):
        ...
        assert result.duplicates_removed > 0 or result.invalid_dates_removed > 0 or result.invalid_numerics_removed > 0
